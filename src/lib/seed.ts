...
export function seed(): DB {
  ...
  const deals: Deal[] = [
    newDeal('m2', { id: 'd1', kind: 'vente', title: 'Vente — 88 av. du Parc #402', listingId: 'l2', contactIds: ['c2'], price: 521000, commissionPct: 5, dates: { mandat: d(-60), paAcceptee: d(-4), inspection: d(3), financement: d(10), acte: d(40), occupation: d(41) }, checklist: { m1: true, m2: true, m3: true, m4: true, m5: true, m6: true, m7: true, n1: true, n2: true, n3: true, n4: true, n5: true, n6: true, k1: true, k2: true, k3: true, p1: true, p2: true }, notaire: 'Me Exemple, notaire', collabBroker: 'Courtier collaborateur — Agence X' }),
    newDeal('m2', { id: 'd2', kind: 'achat', title: 'Achat — David Roy (condo Laval)', contactIds: ['c4'], price: 465000, commissionPct: 2.5, dates: { mandat: d(-45), paAcceptee: d(-2), inspection: d(5), financement: d(12), acte: d(45) }, checklist: { a1: true, a2: true, a3: true, a4: true, a5: true, a6: true, r1: true, r2: true, r3: true, o1: true, o2: true, o3: true, o4: true } }),
