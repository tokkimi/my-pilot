...
export const PLATFORMS_SEED: { name: string; url: string; category: string; usage: string }[] = [
  { name: 'Gmail (équipe)', url: 'https://mail.google.com', category: 'Communication', usage: 'Courriels courtiers, marketing, admin, info' },
  { name: 'iCloud (tél. marketing)', url: 'https://www.icloud.com', category: 'Communication', usage: 'Téléphone marketing, photos' },
  { name: 'Calendly', url: 'https://calendly.com', category: 'Communication', usage: 'Prise de rendez-vous clients' },
  { name: 'Centris', url: 'https://www.centris.ca', category: 'Inscriptions & données', usage: 'Inscriptions, saisie à la source, avis de vente' },
  { name: 'Realtor.ca', url: 'https://www.realtor.ca', category: 'Inscriptions & données', usage: 'Diffusion nationale' },
  { name: 'DuProprio', url: 'https://duproprio.com', category: 'Inscriptions & données', usage: 'Veille / prospection FSBO' },
  { name: 'APCIQ', url: 'https://apciq.ca/', category: 'Inscriptions & données', usage: 'Association, statistiques de marché' },
  { name: 'JLR', url: 'https://www.jlr.ca/me-connecter', category: 'Inscriptions & données', usage: 'Données foncières, comparables, transactions' },
  { name: 'Registre foncier du Québec', url: 'https://www.registrefoncier.gouv.qc.ca/Sirf/', category: 'Inscriptions & données', usage: 'Actes, titres, index des immeubles' },
  { name: 'Immocontact', url: 'https://www.immocontact.com', category: 'Inscriptions & données', usage: 'Gestion des demandes de visites' },
  { name: 'Prospects (CRM)', url: 'https://qc.prospects.com/prospects/logon.do', category: 'Prospection', usage: 'Fiches prospects, plans d’action (fête, Noël)' },
  { name: 'MonProspecteur', url: 'https://www.monprospecteur.com/', category: 'Prospection', usage: 'Listes de prospection' },
  { name: 'ActivePipe', url: 'https://live.activepipe.com/login', category: 'Marketing', usage: 'Courriels automatisés à la base de données' },
  { name: 'Mailchimp', url: 'https://login.mailchimp.com', category: 'Marketing', usage: 'Infolettres acheteurs / vendeurs' },
  { name: 'Canva', url: 'https://www.canva.com', category: 'Marketing', usage: 'Visuels RS, fiches, présentations' },
  { name: 'Artlist.io', url: 'https://artlist.io', category: 'Marketing', usage: 'Musique libre de droits pour reels / vidéos' },
  { name: 'Fiverr', url: 'https://www.fiverr.com', category: 'Marketing', usage: 'Montage vidéo, virtual staging, graphisme' },
  { name: 'Vistaprint', url: 'https://www.vistaprint.ca', category: 'Marketing', usage: 'Cartes, dépliants, envois postaux' },
  { name: 'Nap-Art', url: 'https://www.nap-art.com/', category: 'Marketing', usage: 'Impression / cadeaux clients' },
  { name: 'Pancarte Express', url: 'https://pancarteexpress.com/mon-compte/', category: 'Marketing', usage: 'Pancartes À vendre / Vendu + boîtes à clé' },
  { name: 'Facebook', url: 'https://www.facebook.com', category: 'Réseaux sociaux', usage: 'Publications, pubs, groupes' },
  { name: 'Instagram', url: 'https://www.instagram.com', category: 'Réseaux sociaux', usage: 'Posts, reels, stories' },
  { name: 'TikTok', url: 'https://www.tiktok.com', category: 'Réseaux sociaux', usage: 'Vidéos courtes' },
  { name: 'LinkedIn', url: 'https://www.linkedin.com', category: 'Réseaux sociaux', usage: 'Réseau professionnel, investisseurs' },
  { name: 'YouTube', url: 'https://studio.youtube.com', category: 'Réseaux sociaux', usage: 'Visites vidéo' },
  { name: 'Linktree — The Agency Montréal', url: 'https://linktr.ee/theagencymontrealcourtiers', category: 'Réseaux sociaux', usage: 'Hub de liens des courtiers' },
  { name: 'Google Business Profile', url: 'https://business.google.com', category: 'Réseaux sociaux', usage: 'Avis Google, fiche d’entreprise' },
  { name: 'EZSign / ezMax', url: 'https://www.ezmax.com', category: 'Transactions', usage: 'Signature électronique des contrats et formulaires' },
  { name: 'OACIQ', url: 'https://www.oaciq.com', category: 'Transactions', usage: 'Formulaires, règles et obligations' },
  { name: 'GoDaddy', url: 'https://www.godaddy.com', category: 'Administration', usage: 'Domaines et courriels' },
  { name: 'Paies — gestion Jim', url: '', category: 'Administration', usage: 'Paies et comptabilité' },
  { name: 'ChatGPT', url: 'https://chatgpt.com', category: 'Administration', usage: 'Rédaction de textes, descriptions' },
  { name: 'Google Street View', url: 'https://www.google.com/maps', category: 'Inscriptions & données', usage: 'Préparation RDV — parcourir le quartier' },
]
